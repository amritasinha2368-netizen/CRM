        ...
        <AnimatePresence mode="wait">
          {!collapsed ? (
            <motion.div key="full" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -10 }} className="flex-1 cursor-pointer py-1" onClick={() => navigate('/')}>
              <div className="bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700/80 rounded-xl px-4 py-3 flex items-center justify-center shadow-sm hover:shadow-md transition-all">
                <img
                  src="/logo-original.png"
                  alt="QuantNexa ai Solutions Pvt. Ltd."
                  className="h-16 sm:h-20 w-auto max-w-[260px] object-contain quantnexa-logo"
                />
              </div>
            </motion.div>
          ) : (
            <motion.div key="mini" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.8 }} className="cursor-pointer flex justify-center py-1" onClick={() => navigate('/')}>
              <div className="bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700/80 rounded-xl p-2.5 flex items-center justify-center shadow-sm">
                <img
                  src="/logo-mark.png"
                  alt="QuantNexa ai"
                  className="h-13 w-auto object-contain quantnexa-logo"
                />
              </div>
            </motion.div>
          )}
